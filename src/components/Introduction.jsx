...
const Introduction = () => {
    return (
        <div className='p-4 md:p-7 text-xs w-full max-w-3xl mx-auto'>
            <Terminal>
                <TypingAnimation className='text-xl'>BEHNAM NAJAFLOO | SOFTWARE DEVELOPER</TypingAnimation>

                <AnimatedSpan className="text-green-500 text-xs">
                ...
                <AnimatedSpan className=" text-xs text-blue-500">
                ...
                <TypingAnimation className="text-muted-foreground  text-xs">
